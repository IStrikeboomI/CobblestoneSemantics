...
public class CobblestoneMelterRecipeCategory implements IRecipeCategory<CobblestoneMelterRecipe> {
    ...
    public CobblestoneMelterRecipeCategory(IGuiHelper helper) {
        BACKGROUND = helper.createDrawable(Identifier.fromNamespaceAndPath(CobblestoneSemantics.MOD_ID,"textures/gui/container/cobblestone_melter.png"),4,4,150,75);
        final IDrawableStatic STATIC_ARROW = helper.createDrawable(Identifier.fromNamespaceAndPath(CobblestoneSemantics.MOD_ID,"textures/gui/container/cobblestone_melter.png"),176,0,24,16);
    ...
    @Override
    public void draw(CobblestoneMelterRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
