...
public class CobblestoneSemanticsBlockEntities {
    ...
    public static final Supplier<BlockEntityType<CobblestoneGeneratorBlockEntity>> COBBLESTONE_GENERATOR_BLOCK_ENTITY = BLOCK_ENTITIES.register("cobblestone_generator",() -> new BlockEntityType<>(CobblestoneGeneratorBlockEntity::new,
    ...
    public static final Supplier<BlockEntityType<CobblestoneMelterBlockEntity>> COBBLESTONE_MELTER_BLOCK_ENTITY = BLOCK_ENTITIES.register("cobblestone_melter",() -> new BlockEntityType<>(CobblestoneMelterBlockEntity::new, CobblestoneSemanticsBlocks.COBBLESTONE_MELTER.get()));
    public static final Supplier<BlockEntityType<LavaGeneratorBlockEntity>> LAVA_GENERATOR_BLOCK_ENTITY = BLOCK_ENTITIES.register("lava_generator",() -> new BlockEntityType<>(LavaGeneratorBlockEntity::new, CobblestoneSemanticsBlocks.LAVA_GENERATOR.get()));
    public static final Supplier<BlockEntityType<AllInOneGeneratorBlockEntity>> ALL_IN_ONE_GENERATOR_BLOCK_ENTITY = BLOCK_ENTITIES.register("all_in_one_generator",() -> new BlockEntityType<>(AllInOneGeneratorBlockEntity::new, CobblestoneSemanticsBlocks.ALL_IN_ONE_GENERATOR.get()));
}
