...
public class CobblestoneSemanticsCustomRecipes {
    ...
    public static final Supplier<RecipeSerializer<CobblestoneInfusedObsidianBagRecipe>> COBBLESTONE_INFUSED_OBSIDIAN_BAG_RECIPE = RECIPES.register("cobblestone_infused_obsidian_bag_2", (loc) -> new CustomRecipe.Serializer<>(category -> new CobblestoneInfusedObsidianBagRecipe()));
}
