...
public class CobblestoneSemanticsCustomRecipes {
    ...
    public static final RegistryObject<RecipeSerializer<CobblestoneInfusedObsidianBagRecipe>> COBBLESTONE_INFUSED_OBSIDIAN_BAG_RECIPE = RECIPES.register("cobblestone_infused_obsidian_bag_2", () -> new SimpleCraftingRecipeSerializer<>((p_250892_, p_249920_) -> new CobblestoneInfusedObsidianBagRecipe(p_250892_)));
}
