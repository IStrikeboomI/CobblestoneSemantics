...
public class CobblestoneInfusedObsidianBagScreen extends AbstractContainerScreen<CobblestoneInfusedObsidianBagMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float p_97788_, int p_97789_, int p_97790_) {
        ...
        guiGraphics.blit(RenderType::guiTextured,ResourceLocation.withDefaultNamespace("textures/gui/container/generic_54.png"),i, j, 0, 0, this.getXSize(), 3 * 18 + 17,256,256);
        guiGraphics.blit(RenderType::guiTextured,ResourceLocation.withDefaultNamespace("textures/gui/container/generic_54.png"),i, j + 3 * 18 + 16, 0, 126, this.getXSize(), 96,256,256);
    }
