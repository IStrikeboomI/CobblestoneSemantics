...
public class CobblestoneBagContainer extends Container {
    private BagItemHandler handler;
    public CobblestoneBagContainer(int windowId, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        super(CobblestoneSemanticsContainers.COBBLESTONE_BAG_MENU.get(), windowId);
    ...
    public boolean stillValid(PlayerEntity pPlayer) {
        return pPlayer.getItemInHand(pPlayer.getUsedItemHand()).getItem() == CobblestoneSemanticsItems.COBBLESTONE_BAG.get();
    }
}
