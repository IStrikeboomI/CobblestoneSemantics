...
public class ContainerCobblestoneInfusedObsidianBag extends Container {

    IInventory playerInv;
    ItemStack stack;
    IItemHandler handler;
    public ContainerCobblestoneInfusedObsidianBag(IInventory playerInv, ItemStack stack) {
    ...
    public boolean canInteractWith(EntityPlayer playerIn) {
        return  !playerIn.isSneaking() && playerIn.getHeldItemMainhand().getItem() == ModItems.cobblestoneInfusedObsidianBag;
    }
}
