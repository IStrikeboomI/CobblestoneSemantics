...
public class CobblestoneMelter extends Block {
    ...
    public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
        ...
        tooltip.add(I18n.format("tile." + CobblestoneSemantics.MOD_ID + ".tooltip.produces") + " "+
                ConfigHandler.BLOCKS.MELTER.lavaPerCobblestone + " " +
                I18n.format("tile." + CobblestoneSemantics.MOD_ID + ".tooltip.lava") + " " +ConfigHandler.BLOCKS.MELTER.melterDelay + " " + I18n.format("tile." + CobblestoneSemantics.MOD_ID + ".tooltip.ticks"));
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        if (!worldIn.isRemote) {
            ...
            playerIn.openGui(CobblestoneSemantics.instance,GuiHandler.COBBLESTONEMELTER,worldIn, pos.getX(), pos.getY(),pos.getZ());
        }
        return true;
    }
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileEntityCobblestoneMelter();
    }
